...
SRC="data/binding/phillips2021binding_cr9114_h1_kd.csv"
OUT="processed/binding/phillips2021binding/cr9114_h1_kd"

echo "[$(date -u +%H:%M:%S)] Converting $SRC ..."
python3 "scripts/prepare/binding/phillips2021binding/cr9114_h1_kd/convert.py" "$SRC" "$OUT"
