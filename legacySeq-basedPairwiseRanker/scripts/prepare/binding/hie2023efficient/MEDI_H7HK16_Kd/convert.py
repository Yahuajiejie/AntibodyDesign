#!/usr/bin/env python3
"""Convert hie2023efficient_MEDI_H7HK16_Kd.csv -> standard training table.

Study:      hie2023efficient
Table:      MEDI_H7HK16_Kd
Antigen:    Influenza A H7 HA (HK16)
rank_label: fitness = neg_log_Kd; MEDI lineage vs H7 HK16 HA
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "hie2023efficient"
TABLE_ID       = "MEDI_H7HK16_Kd"
SOURCE_FILE    = "data/binding/hie2023efficient_MEDI_H7HK16_Kd.csv"
ANTIBODY_TYPE  = "IgG"   # Fv | Fab | IgG | scFv | VHH | unknown
ANTIGEN_KEY    = "H7_HK16_HA"
ANTIGEN_NAME   = "Influenza A H7 HA (HK16)"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "SPR"
METRIC_NAME    = "neg_log10_kd_M"
METRIC_UNIT    = "-log10(KD/M)"
TRANSFORM_RULE = "fitness = neg_log_Kd; MEDI lineage vs H7 HK16 HA"
