#!/usr/bin/env python3
"""Convert garbinski2023_kd.csv -> standard training table.

Study:      garbinski2023
Table:      kd
Antigen:    Unknown proprietary antigen
rank_label: fitness = -log(KD/M); antigen identity not disclosed in source
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "garbinski2023"
TABLE_ID       = "kd"
SOURCE_FILE    = "data/binding/garbinski2023_kd.csv"
...
TRANSFORM_RULE = "fitness = -log(KD/M); antigen identity not disclosed in source"
