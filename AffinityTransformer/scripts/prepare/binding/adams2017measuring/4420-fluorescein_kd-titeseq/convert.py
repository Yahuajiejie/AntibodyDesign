...
# ── CONFIG ───────────────────────────────────────────────────────────────────
STUDY_ID       = "adams2017measuring"
TABLE_ID       = "4420-fluorescein_kd-titeseq"
SOURCE_FILE    = "data/binding/adams2017measuring_4420-fluorescein_kd-titeseq.csv"
ANTIBODY_TYPE  = "scFv"
ANTIGEN_KEY    = "Fluorescein"
ANTIGEN_NAME   = "Fluorescein (small molecule)"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "Tite-seq Kd"
ASSAY_TYPE     = "binding"
...
GROUP_ID       = "adams2017measuring/4420-fluorescein_kd-titeseq/Fluorescein/neg_log10_kd_M/experimental"
# rank_label is computed from the raw "fitness" column (= K_D in M); the raw
# "Kd (Tite-Seq) [M]" column is identical and not read.


def _rl(raw) -> "float | None":
    # fitness = raw Kd [M]; lower Kd = better binding → higher -log10 = better
    try:
