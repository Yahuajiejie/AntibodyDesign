...
TABLE_ID       = "Syncytin2_spr"
SOURCE_FILE    = "data/binding/kothiwal2025htp_Syncytin2_spr.csv"
ANTIBODY_TYPE  = "IgG"
ANTIGEN_KEY    = "Syncytin2"
ANTIGEN_NAME   = "Syncytin-2 (HERV-W Env)"
...
TRANSFORM_RULE = "rank_label = fitness (already -log10(KD/M))"
LABEL_KIND     = "experimental"
GROUP_ID       = "kothiwal2025htp/Syncytin2_spr/Syncytin2/neg_log10_kd_M/experimental"


def _rl(raw) -> "float | None":
    # fitness = -log10(KD/M) pre-computed; no transform needed
    try:
        v = float(raw)
