...
# ── CONFIG ───────────────────────────────────────────────────────────────────
# NOTE: Column says Kd [M] but range is 3.3–2946.89, consistent with nM.
# Values treated as nM. If confirmed otherwise, update TRANSFORM_RULE and _rl().
STUDY_ID       = "kirby2024retrospective"
TABLE_ID       = "ab-SARSCoV2_kd"
SOURCE_FILE    = "data/binding/kirby2024retrospective_ab-SARSCoV2_kd.csv"
ANTIBODY_TYPE  = "IgG"
ANTIGEN_KEY    = "CoV2_Spike"
ANTIGEN_NAME   = "SARS-CoV-2 Spike"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "KD binding assay"
ASSAY_TYPE     = "binding"
METRIC_NAME    = "neg_log10_kd_M"
METRIC_UNIT    = "-log10(KD/M)"
METRIC_DIRECTION = "higher_is_better"
TRANSFORM_RULE = "rank_label = -log10(Kd_nM * 1e-9)  [column Kd [M] treated as nM]"
LABEL_KIND     = "experimental"
GROUP_ID       = "kirby2024retrospective/ab-SARSCoV2_kd/CoV2_Spike/neg_log10_kd_M/experimental"


def _rl(raw) -> "float | None":
    # Column Kd [M] range 3.3–2946.89 is clearly nM; treating as nM.
    try:
