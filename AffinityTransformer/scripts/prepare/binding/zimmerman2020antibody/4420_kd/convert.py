#!/usr/bin/env python3
"""Convert zimmerman2020antibody_4420_kd.csv -> standard training table.

Study:      zimmerman2020antibody
Table:      4420_kd
Antigen:    Fluorescein (small molecule hapten; no protein sequence)
rank_label: fitness = -log(KD/M); 4420 scFv variants
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "zimmerman2020antibody"
TABLE_ID       = "4420_kd"
SOURCE_FILE    = "data/binding/zimmerman2020antibody_4420_kd.csv"
ANTIBODY_TYPE  = "scFv"   # Fv | Fab | IgG | scFv | VHH | unknown
ANTIGEN_KEY    = "Fluorescein"
ANTIGEN_NAME   = "Fluorescein (small molecule hapten; no protein sequence)"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "SPR"
METRIC_NAME    = "neg_log10_kd_M"
METRIC_UNIT    = "-log10(KD/M)"
TRANSFORM_RULE = "fitness = -log(KD/M); 4420 scFv variants"
