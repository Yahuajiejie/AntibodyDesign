#!/usr/bin/env python3
"""Convert hie2023efficient_MEDIUCA_H4Hubei_Kd.csv -> standard training table.

Study:      hie2023efficient
Table:      MEDIUCA_H4Hubei_Kd
Antigen:    Influenza A H4 HA (Hubei)
rank_label: fitness = neg_log_Kd; MEDI-UCA lineage vs H4 Hubei HA
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "hie2023efficient"
TABLE_ID       = "MEDIUCA_H4Hubei_Kd"
SOURCE_FILE    = "data/binding/hie2023efficient_MEDIUCA_H4Hubei_Kd.csv"
ANTIBODY_TYPE  = "IgG"   # Fv | Fab | IgG | scFv | VHH | unknown
ANTIGEN_KEY    = "H4_Hubei_HA"
ANTIGEN_NAME   = "Influenza A H4 HA (Hubei)"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "SPR"
METRIC_NAME    = "neg_log10_kd_M"
METRIC_UNIT    = "-log10(KD/M)"
TRANSFORM_RULE = "fitness = neg_log_Kd; MEDI-UCA lineage vs H4 Hubei HA"
