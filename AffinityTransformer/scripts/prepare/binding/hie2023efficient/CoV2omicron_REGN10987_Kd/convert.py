#!/usr/bin/env python3
"""Convert hie2023efficient_CoV2omicron_REGN10987_Kd.csv -> standard training table.

Study:      hie2023efficient
Table:      CoV2omicron_REGN10987_Kd
Antigen:    SARS-CoV-2 Omicron RBD
rank_label: fitness = neg_log_Kd; REGN10987 lineage vs CoV2 Omicron RBD
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "hie2023efficient"
TABLE_ID       = "CoV2omicron_REGN10987_Kd"
SOURCE_FILE    = "data/binding/hie2023efficient_CoV2omicron_REGN10987_Kd.csv"
ANTIBODY_TYPE  = "IgG"   # Fv | Fab | IgG | scFv | VHH | unknown
ANTIGEN_KEY    = "CoV2_Omicron_RBD"
ANTIGEN_NAME   = "SARS-CoV-2 Omicron RBD"
ANTIGEN_SEQ    = None
ANTIGEN_SOURCE = "missing"
ASSAY_NAME     = "SPR"
METRIC_NAME    = "neg_log10_kd_M"
METRIC_UNIT    = "-log10(KD/M)"
TRANSFORM_RULE = "fitness = neg_log_Kd; REGN10987 lineage vs CoV2 Omicron RBD"
