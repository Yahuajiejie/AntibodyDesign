#!/usr/bin/env python3
"""Convert hie2023efficient_CoV2Beta_C143_Kd.csv -> standard training table.

Study:      hie2023efficient
Table:      CoV2Beta_C143_Kd
Antigen:    SARS-CoV-2 Beta variant Spike S2P
rank_label: fitness = neg_log_Kd; C143 lineage vs CoV2 Beta S2P
"""
# ── CONFIG ────────────────────────────────────────────────────────────────────
STUDY_ID       = "hie2023efficient"
TABLE_ID       = "CoV2Beta_C143_Kd"
SOURCE_FILE    = "data/binding/hie2023efficient_CoV2Beta_C143_Kd.csv"
...
TRANSFORM_RULE = "fitness = neg_log_Kd; C143 lineage vs CoV2 Beta S2P"
