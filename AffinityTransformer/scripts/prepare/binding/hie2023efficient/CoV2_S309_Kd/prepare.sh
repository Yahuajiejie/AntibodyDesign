...
SRC="data/binding/hie2023efficient_CoV2_S309_Kd.csv"
OUT="processed/binding/hie2023efficient/CoV2_S309_Kd"

echo "[$(date -u +%H:%M:%S)] Converting $SRC ..."
python3 "scripts/prepare/binding/hie2023efficient/CoV2_S309_Kd/convert.py" "$SRC" "$OUT"
